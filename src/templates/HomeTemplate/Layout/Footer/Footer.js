...
export default function Footer() {
    const { arrTheater } = useSelector(rootReducer => rootReducer.TheaterManageReducer);

    const arrHeThongRap = _.map(arrTheater, (heThongRap) => _.pick(heThongRap, ['maHeThongRap', 'tenHeThongRap', 'logo']));
    return (
